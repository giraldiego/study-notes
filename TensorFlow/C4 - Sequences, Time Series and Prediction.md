...
- **trend:** where time series have a specific direction that they're moving in.
- **seasonality:** which is seen when patterns repeat at predictable intervals.
- **Autocorrelation:** Namely it correlates with a delayed copy of itself often called a lag. 
